...
<body>
	...
	<form action="<c:url value='/boardList'/>" method="get" id="searchFrm">
		...
		<input type="text" name="board_title" placeholder ="검색 제목을 입력하세요" value="<c:out value='${paging.board_title }'/>">
		<input type="text" name="board_content" placeholder="검색 내용을 입력하세요" value="<c:out value='${paging.board_content }'/>">
